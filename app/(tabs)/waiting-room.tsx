...
import { getSocket, getSocketUrl } from "../../services/socket-service";
;
...
export default function WaitingRoom({ gameId }: { gameId: string }) {
  ...
  useEffect(() => {
    ...
    socket.on("playersUpdate", (updatedPlayers: Player[]) => setPlayers(updatedPlayers));
    socket.on("gameStarted", () => router.push(`/game?gameId=${gameId}`));
