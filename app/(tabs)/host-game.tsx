...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#87CEEB", paddingHorizontal: 20 },
  backButton: {
    position: "absolute",
    top: 60,
    left: 20,
  ...
  playersContainer: { marginTop: 40, flex: 1 },
  playersTitle: {
    fontSize: 32,
    fontWeight: "bold",
    color: "white",
  ...
  buttonContainer: { marginBottom: 120, alignItems: "center" },
  startButton: {
    backgroundColor: "#C28B51",
    paddingVertical: 16,
    alignItems: "center",
  ...
  startButtonDisabled: { backgroundColor: "#a0a0a0" },
  startButtonText: {
    color: "white",
    fontSize: 28,
    fontWeight: "bold",
